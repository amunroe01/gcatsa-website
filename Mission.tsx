...
const DOMAINS = [
  ...
  { icon: HomeIcon, label: "Architecture" },
  ...
  { icon: Clapperboard, label: "Media Production" },
    ...
    <section className="bg-white py-20 sm:py-24" aria-labelledby="mission-heading">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        <Reveal className="mx-auto max-w-3xl text-center">
          <p className="eyebrow justify-center text-4xl tracking-wide sm:text-5xl">Our Mission</p>
          <h2 id="mission-heading" className="mt-3 text-3xl font-black text-navy-800 sm:text-4xl">
            Building Innovators, One Dream and Design at a Time
          </h2>
          <p className="mt-5 font-body text-base leading-relaxed text-navy-700 sm:text-lg">
            ...
            design, digital media, architecture, cybersecurity, Artificial
            Intelligence, video game and web design, robotics and drones and
            so much more. Technical and problem solving skills that carry
            them into high school, college, and high demand careers.
          </p>
        </Reveal>

        <div className="mt-14 grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-6 lg:gap-4">
